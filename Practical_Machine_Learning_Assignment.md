...
<ol class=list-inline>
    ...
    Column #34 	 "avg_yaw_belt"
    Column #35 	 "stddev_yaw_belt"
    Column #36 	 "var_yaw_belt"
    Column #37 	 "gyros_belt_x"
    Column #38 	 "gyros_belt_y"
    Column #39 	 "gyros_belt_z"
    Column #40 	 "accel_belt_x"
    Column #41 	 "accel_belt_y"
    Column #42 	 "accel_belt_z"
    Column #43 	 "magnet_belt_x"
    Column #44 	 "magnet_belt_y"
    Column #45 	 "magnet_belt_z"
    Column #46 	 "roll_arm"
    Column #47 	 "pitch_arm"
    Column #48 	 "yaw_arm"
    Column #49 	 "total_accel_arm"
    Column #50 	 "var_accel_arm"
    Column #51 	 "avg_roll_arm"
    Column #52 	 "stddev_roll_arm"
    Column #53 	 "var_roll_arm"
    Column #54 	 "avg_pitch_arm"
    Column #55 	 "stddev_pitch_arm"
    Column #56 	 "var_pitch_arm"
    Column #57 	 "avg_yaw_arm"
    Column #58 	 "stddev_yaw_arm"
    Column #59 	 "var_yaw_arm"
    Column #60 	 "gyros_arm_x"
    Column #61 	 "gyros_arm_y"
    Column #62 	 "gyros_arm_z"
    Column #63 	 "accel_arm_x"
    Column #64 	 "accel_arm_y"
    Column #65 	 "accel_arm_z"
    Column #66 	 "magnet_arm_x"
    Column #67 	 "magnet_arm_y"
    Column #68 	 "magnet_arm_z"
    Column #69 	 "kurtosis_roll_arm"
    Column #70 	 "kurtosis_picth_arm"
    Column #71 	 "kurtosis_yaw_arm"
    Column #72 	 "skewness_roll_arm"
    Column #73 	 "skewness_pitch_arm"
    Column #74 	 "skewness_yaw_arm"
    Column #75 	 "max_roll_arm"
    Column #76 	 "max_picth_arm"
    Column #77 	 "max_yaw_arm"
    Column #78 	 "min_roll_arm"
    Column #79 	 "min_pitch_arm"
    Column #80 	 "min_yaw_arm"
    Column #81 	 "amplitude_roll_arm"
    Column #82 	 "amplitude_pitch_arm"
    Column #83 	 "amplitude_yaw_arm"
    Column #84 	 "roll_dumbbell"
    Column #85 	 "pitch_dumbbell"
    Column #86 	 "yaw_dumbbell"
    Column #87 	 "kurtosis_roll_dumbbell"
    Column #88 	 "kurtosis_picth_dumbbell"
    Column #89 	 "kurtosis_yaw_dumbbell"
    Column #90 	 "skewness_roll_dumbbell"
    Column #91 	 "skewness_pitch_dumbbell"
    Column #92 	 "skewness_yaw_dumbbell"
    Column #93 	 "max_roll_dumbbell"
    Column #94 	 "max_picth_dumbbell"
    Column #95 	 "max_yaw_dumbbell"
    Column #96 	 "min_roll_dumbbell"
    Column #97 	 "min_pitch_dumbbell"
    Column #98 	 "min_yaw_dumbbell"
    Column #99 	 "amplitude_roll_dumbbell"
    Column #100 	 "amplitude_pitch_dumbbell"
    Column #101 	 "amplitude_yaw_dumbbell"
    Column #102 	 "total_accel_dumbbell"
    Column #103 	 "var_accel_dumbbell"
    Column #104 	 "avg_roll_dumbbell"
    Column #105 	 "stddev_roll_dumbbell"
    Column #106 	 "var_roll_dumbbell"
    Column #107 	 "avg_pitch_dumbbell"
    Column #108 	 "stddev_pitch_dumbbell"
    Column #109 	 "var_pitch_dumbbell"
    Column #110 	 "avg_yaw_dumbbell"
    Column #111 	 "stddev_yaw_dumbbell"
    Column #112 	 "var_yaw_dumbbell"
    Column #113 	 "gyros_dumbbell_x"
    Column #114 	 "gyros_dumbbell_y"
    Column #115 	 "gyros_dumbbell_z"
    Column #116 	 "accel_dumbbell_x"
    Column #117 	 "accel_dumbbell_y"
    Column #118 	 "accel_dumbbell_z"
    Column #119 	 "magnet_dumbbell_x"
    Column #120 	 "magnet_dumbbell_y"
    Column #121 	 "magnet_dumbbell_z"
    Column #122 	 "roll_forearm"
    Column #123 	 "pitch_forearm"
    Column #124 	 "yaw_forearm"
    Column #125 	 "kurtosis_roll_forearm"
    Column #126 	 "kurtosis_picth_forearm"
    Column #127 	 "kurtosis_yaw_forearm"
    Column #128 	 "skewness_roll_forearm"
    Column #129 	 "skewness_pitch_forearm"
    Column #130 	 "skewness_yaw_forearm"
    Column #131 	 "max_roll_forearm"
    Column #132 	 "max_picth_forearm"
    Column #133 	 "max_yaw_forearm"
    Column #134 	 "min_roll_forearm"
    Column #135 	 "min_pitch_forearm"
    Column #136 	 "min_yaw_forearm"
    Column #137 	 "amplitude_roll_forearm"
    Column #138 	 "amplitude_pitch_forearm"
    Column #139 	 "amplitude_yaw_forearm"
    Column #140 	 "total_accel_forearm"
    Column #141 	 "var_accel_forearm"
    Column #142 	 "avg_roll_forearm"
    Column #143 	 "stddev_roll_forearm"
    Column #144 	 "var_roll_forearm"
    Column #145 	 "avg_pitch_forearm"
    Column #146 	 "stddev_pitch_forearm"
    Column #147 	 "var_pitch_forearm"
    Column #148 	 "avg_yaw_forearm"
    Column #149 	 "stddev_yaw_forearm"
    Column #150 	 "var_yaw_forearm"
    Column #151 	 "gyros_forearm_x"
    Column #152 	 "gyros_forearm_y"
    Column #153 	 "gyros_forearm_z"
    Column #154 	 "accel_forearm_x"
    Column #155 	 "accel_forearm_y"
    Column #156 	 "accel_forearm_z"
    Column #157 	 "magnet_forearm_x"
    Column #158 	 "magnet_forearm_y"
    Column #159 	 "magnet_forearm_z"
    Column #160 	 "classe"
